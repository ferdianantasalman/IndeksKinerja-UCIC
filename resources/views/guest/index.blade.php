...
<head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Sistem Indeks Kinerja</title>

    <!-- ===============================================-->
    <!--    Favicons-->
    <!-- ===============================================-->
    <link rel="apple-touch-icon" sizes="180x180"
        href="{{ asset('assets_landing/assets/img/favicons/apple-touch-icon.png') }}">
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('assets_landing/assets/img/favicons/favicon-32x32.png') }}">

    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('assets_landing/assets/img/favicons/favicon-16x16.png') }}">
    <link rel="shortcut icon" type="image/x-icon" href="{{ asset('assets_landing/assets/img/favicons/favicon.ico') }}">
    <link rel="manifest" href="{{ asset('assets_landing/assets/img/favicons/manifest.json') }}">
    <meta name="msapplication-TileImage" content="{{ asset('assets_landing/assets/img/favicons/mstile-150x150.png') }}">
    ...
    <link href="https://fonts.googleapis.com/css2?family=Manrope:wght@200;300;400;500;600;700&amp;display=swap"
        rel="stylesheet">
    <link href="{{ asset('assets_landing/vendors/prism/prism.css') }}" rel="stylesheet">
...
<body>
    ...
    <main class="main" id="top">
        <nav class="navbar navbar-expand-lg fixed-top navbar-dark" data-navbar-on-scroll="data-navbar-on-scroll">
            <div class="container"><a class="navbar-brand" href="#"><img height="80" width="150"
                        src="{{ asset('assets_landing/assets/img/logo ucic.png') }}" alt="" /></a><button
                        ...
                        <div class="swiper-container swiper-shadow swiper-theme"
                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide text-center"><img
                                        src="{{ asset('assets_landing/assets/img/logos/boldo.png') }}"
                                        alt="" /></div>
                                <div class="swiper-slide text-center"><img
                                        src="{{ asset('assets_landing/assets/img/logos/presto.png') }}"
                                        alt="" /></div>
                                <div class="swiper-slide text-center"><img
                                        src="{{ asset('assets_landing/assets/img/logos/boldo.png') }}"
                                        alt="" /></div>
        ...
        <section>
            <div class="container">
                ...
                <h2 class="mx-auto text-center fs-lg-6 fs-md-5 w-lg-75">Handshake infographic mass market crowdfunding
                    iteration.</h2>
                <div class="row gx-xl-7 mt-5">
                    <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100"
                            src="{{ asset('assets_landing/assets/img/services/1.png') }}" alt="" />
                        <h4 class="mt-3 my-1">Cool feature title</h4>
                        <p class="fs-1 mb-0">Learning curve network effects return on investment.</p><a
                    ...
                    <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100"
                            src="{{ asset('assets_landing/assets/img/services/2.png') }}" alt="" />
                    ...
                    <div class="col-md-4 mb-6 mb-md-0 text-center text-md-start"><img class="w-50 w-md-100"
                            src="{{ asset('assets_landing/assets/img/services/3.png') }}" alt="" />
                        <h4 class="mt-3 my-1">Cool feature title</h4>
                        <p class="fs-1 mb-0">Learning curve network effects return on investment.</p><a
                            class="text-dark fs-1 pb-2 fw-bold border-black border-bottom text-decoration-none"
                            href="#">Explore page<i class="fa-solid fa-arrow-right ms-2"></i></a>
            ...
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6 text-center text-lg-start"><img class="img-fluid"
                            src="{{ asset('assets_landing/assets/img/offer/1.png') }}" alt="" /></div>
                    <div class="col-lg-6">
                        <h1 class="fs-xl-5 fs-lg-4 fs-3">We connect our customers with the best, and help them keep
                            up-and stay open.</h1>
                        <ul class="list-unstyled my-xl-5 my-3">
                            <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><i
                                    class="fa-solid fa-circle-check fs-4 text-dark"></i><span>We connect our customers
                                    with the best.</span></li>
                            <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><i
                                    class="fa-solid fa-circle-check fs-4 text-dark"></i><span>Advisor success customer
                                    launch party.</span></li>
                            <li class="fs-2 my-4 d-flex align-items-center gap-3 text-black"><i
        ...
        <section class="pt-8 pt-lg-0">
            <div class="container">
                <div class="d-flex flex-column-reverse flex-lg-row">
                    <div class="col-lg-6">
                        <h1 class="fs-lg-4 fs-md-3 fs-xl-5 mb-5">We connect our customers with the best, and help them
                            keep up-and stay open.</h1>
                        <ul class="list-unstyled">
                            <li class="fs-2 shadow-sm offer-list-item"><i
                                    class="fa-solid fa-leaf fs-lg-4 fs-3"></i><span>We connect our customers with the
                                    best.</span></li>
                            <li class="fs-2 shadow-sm offer-list-item"><i
                                    class="fa-solid fa-eye fs-lg-4 fs-3"></i><span>Advisor success customer launch
                                    party.</span></li>
                            <li class="fs-2 shadow-sm offer-list-item"><i
                                    class="fa-solid fa-sun fs-lg-4 fs-3"></i><span>Business-to-consumer long
                                    tail.</span></li>
                        </ul>
                    </div>
                    <div class="col-lg-6 text-center text-lg-end"><img class="img-fluid"
                            src="{{ asset('assets_landing/assets/img/offer/2.png') }}" alt="" /></div>
                </div>
            </div><!-- end of .container-->
        </section><!-- <section> close ============================-->
        <!-- ============================================-->
        ...
        <section class="bg-dark pt-6">
            <div class="container">
                <div class="col-md-6">
                    <h1 class="text-white fs-lg-5 fs-md-5 fs-2">Profi Dosen
                    </h1>
                </div>
                        ...
                        <div class="swiper-wrapper mt-5">
                            <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                                <div class="d-flex flex-column justify-content-between h-100">
                                    <img src="{{ asset('assets_landing/assets/img/review/1.png') }}" alt="">
                                    <div class="text-black text-center mt-3">
                                        <h5 class="mb-0 fw-bold text-dark">Ferdi Ananta Salman, S.Kom</h5>
                                        <p>Teknik
                                            Informatika</p>
                                    </div>
                                    <div class="text-black mt-3">
                                        <p class="mb-0 fw-bold text-dark">Google Scholar</p>
                                    </div>
                                    <a href="">
                                        <p class="mt-1">asdsad</p>
                                    </a>
                                    <div class="text-black mt-2">
                                        <p class="mb-0 fw-bold text-dark">Scopus</p>
                                    </div>
                                    <p class="mt-1">asdas</p>
                                </div>
                            </div>
                            <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                                <div class="d-flex flex-column justify-content-between h-100">
                            ...
                            <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                                <div class="d-flex flex-column justify-content-between h-100">
                                    <h4 class="text-black">“Release facebook responsive web design business model
                                        canvas seed money monetization.”</h4>
                                    <div class="d-flex align-items-center gap-3 mt-5"><img
                                            src="{{ asset('assets_landing/assets/img/review/3.png') }}"
                                            alt="" />
                            ...
                            <div class="swiper-slide bg-white p-5 rounded-3 h-auto">
                                <div class="d-flex flex-column justify-content-between h-100">
                                    <h4 class="text-black">“Buyer buzz partner network disruptive non-disclosure
                                        agreement business”</h4>
                                    <div class="d-flex align-items-center gap-3 mt-5"><img
                                            src="{{ asset('assets_landing/assets/img/review/1.png') }}"
                                            alt="" />
                                        <div class="text-black">
        ...
        <!-- <section> begin ============================-->
        <section>
            <div class="container"><img class="img-fluid" src="{{ asset('assets_landing/assets/img/offer/3.png') }}"
                    alt="" />
                <div class="row mt-5 align-items-center">
                    <div class="col-md-6">
                        <h2 class="fs-md-4 fs-3 pt-3">We connect our customers with the best, and help them keep up-and
                            stay open.</h2>
                    </div>
                    <div class="col-md-6">
                        <div class="accordion accordion-flush" id="accordionFlushExample">
                            ...
                            <h2 class="accordion-header border-bottom" id="srgdgfdgdgg45"><button
                                    ...
                                    aria-expanded="false" aria-controls="srgdgfdgdgg45"><span class="fs-1 pe-3">We
                                        connect our customers with the best?</span></button></h2>
                ...
                <div class="row mt-7 gx-xl-7">
                    <div class="col-md-4 text-center text-md-start h-auto mb-5">
                        <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img
                                    class="w-75 w-md-100 rounded-2"
                                    src="{{ asset('assets_landing/assets/img/blog/1.png') }}" alt="" /></a>
                            <div
                                class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3">
                                <a href="#">
                                    <p class="fw-bold mb-0 text-black">Category</p>
                                </a>
                                <p class="mb-0">November 22, 2021</p>
                            </div><a href="#">
                                <h5 class="mt-1 mb-3 fs-0 fs-md-1">Pitch termsheet backing validation focus release.
                                </h5>
                            </a>
                            <div
                                class="d-flex align-items-center justify-content-center justify-content-md-start gap-3">
                                <img class="img-fluid"
                                    src="{{ asset('assets_landing/assets/img/blog/profile1.png') }}"
                                    alt="" /><a href="#">
                    ...
                    <div class="col-md-4 text-center text-md-start h-auto mb-5">
                        <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img
                                    class="w-75 w-md-100 rounded-2"
                                    src="{{ asset('assets_landing/assets/img/blog/2.png') }}" alt="" /></a>
                            <div
                                class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3">
                                <a href="#">
                                    <p class="fw-bold mb-0 text-black">Category</p>
                                ...
                                <h5 class="mt-1 mb-3 fs-0 fs-md-1">Seed round direct mailing non-disclosure agreement
                                    graphical user interface rockstar.</h5>
                            </a>
                            <div
                                class="d-flex align-items-center justify-content-center justify-content-md-start gap-3">
                                <img class="img-fluid"
                                    src="{{ asset('assets_landing/assets/img/blog/profile2.png') }}"
                                    alt="" /><a href="#">
                    ...
                    <div class="col-md-4 text-center text-md-start h-auto mb-5">
                        <div class="d-flex justify-content-between flex-column h-100"><a href="#"><img
                                    class="w-75 w-md-100 rounded-2"
                                    src="{{ asset('assets_landing/assets/img/blog/3.png') }}" alt="" /></a>
                            <div
                                class="d-flex align-items-center justify-content-center justify-content-md-start gap-2 mt-3">
                                <a href="#">
                                    <p class="fw-bold mb-0 text-black">Category</p>
                                ...
                                <h5 class="mt-1 mb-3 fs-0 fs-md-1">Beta prototype sales iPad gen-z marketing network
                                    effects value proposition</h5>
                            </a>
                            <div
                                class="d-flex align-items-center justify-content-center justify-content-md-start gap-3">
                                <img class="img-fluid"
                                    src="{{ asset('assets_landing/assets/img/blog/profile3.png') }}"
                                    alt="" /><a href="#">
    ...
    <section>
        <div class="container bg-dark overflow-hidden rounded-1">
            ...
            <div class="px-5 py-7 position-relative">
                <h1 class="text-center w-lg-75 mx-auto fs-lg-6 fs-md-4 fs-3 text-white">An enterprise template to ramp
                    up your company website</h1>
                <div class="row justify-content-center mt-5">
                    <div class="col-auto w-100 w-lg-50"><input class="form-control mb-2 border-light fs-1"
                            type="email" placeholder="Your email address" /></div>
                    <div class="col-auto mt-2 mt-lg-0"><button class="btn btn-success text-dark fs-1">Start
                            now</button></div>
                </div>
            </div>
        </div><!-- end of .container-->
    ...
    <section class="pt-0">
        <div class="container">
            <div class="row justify-content-between">
                <div class="col-lg-6 col-sm-12"><a href="#"><img class="img-fluid mt-5 mb-4"
                            src="{{ asset('assets_landing/assets/img/black-logo.png') }}" alt="" /></a>
    ...
    <!--    JavaScripts-->
    <!-- ===============================================-->
    <script src="{{ asset('assets_landing/vendors/popper/popper.min.js') }}"></script>
    <script src="{{ asset('assets_landing/vendors/bootstrap/bootstrap.min.js') }}"></script>
    <script src="{{ asset('assets_landing/vendors/anchorjs/anchor.min.js') }}"></script>
    <script src="{{ asset('assets_landing/vendors/is/is.min.js') }}"></script>
    <script src="{{ asset('assets_landing/vendors/fontawesome/all.min.js') }}"></script>
    <script src="{{ asset('assets_landing/vendors/lodash/lodash.min.js') }}"></script>
    <script src="https://polyfill.io/v3/polyfill.min.js?features=window.scroll"></script>
    <script src="{{ asset('assets_landing/vendors/prism/prism.js') }}"></script>
    <script src="{{ asset('assets_landing/vendors/swiper/swiper-bundle.min.js') }}"></script>
    <script src="{{ asset('assets_landing/assets/js/theme.js') }}"></script>
</body>
