    ...
    <div class="container-fluid pt-4 px-4">
        <div class="col-12">
            <div class="bg-light rounded h-100 p-4">
                ...
                <form action="{{ route('jenjang_fungsional.questions.update', $questions->id) }}" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="mb-3">
                    ...
                    {{-- <div class="row"> --}}
                    <a href="/admin/jenjang_fungsional/questions" class="btn btn-primary">Kembali</a>
