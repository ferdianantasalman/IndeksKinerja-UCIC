...
<head>
    <meta charset="utf-8">
    <title>Sistem Indeks Kinerja UCIC</title>
...
<body>
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <!-- Sidebar Start -->
        @include('fakultas.layouts.sidebar')
        <!-- Sidebar End -->
        ...
        <div class="content">
            <!-- Navbar Start -->
            @include('fakultas.layouts.navbar')
            <!-- Navbar End -->

            <!-- Content -->
            @yield('content-fakultas')
            <!-- Content End -->

            <!-- Footer Start -->
            @include('fakultas.layouts.footer')
            <!-- Footer End -->
        </div>
        <!-- Content End -->
